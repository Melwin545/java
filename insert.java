...
/*# sourceURL=ace/css/ace_scrollbar.css */</style>
  ...
  <link rel="stylesheet" href="./insert_files/fonts.css">
  ...
  <script async="" src="./insert_files/gtm.js.download"></script><script>
  ...
  <script src="./insert_files/stub.min.js.download"></script>
  <script async="" src="./insert_files/cmp.js.download"></script>
  ...
  <link href="./insert_files/css2" rel="stylesheet">
  <link rel="stylesheet" href="./insert_files/styles.94017793f7f1bebc8d88.css">
  <!-- Global site tag (gtag.js) - Google Analytics -->

<script src="./insert_files/mode-java.js.download"></script><script src="./insert_files/theme-twilight.js.download"></script></head>
        ...
        <div class="nav-header-wrapper">
          <div class="nav-logo-title-wrapper">
            <a href="https://www.programiz.com/" target="_blank" class="nav-logo-link">
              <img id="nav-logo" src="./insert_files/logo-inverted.svg">
            </a>
          </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M29.9196 33.8549C32.0265 33.0205 36.1973 31.7405 38.4533 35.8806C38.9712 36.8532 40.1207 31.7059 35.9618 26.8506L35.8873 26.7661C35.9081 26.6956 35.9286 26.6286 35.9487 26.5631C35.9889 26.4317 36.0272 26.3061 36.0638 26.1702C38.159 18.6894 33.1565 9.75527 24.7445 5C28.3777 9.66308 30.0412 15.2949 28.5857 20.25C28.4536 20.7083 28.2951 21.1588 28.1109 21.5995C27.9383 21.4841 27.7225 21.361 27.4439 21.2149C21.1601 17.3644 15.3113 12.871 9.99608 7.81009C13.1936 12.2165 16.7354 16.3731 20.5896 20.2423C17.8902 18.7855 10.3022 13.638 5.53115 9.5593C6.1325 10.4985 6.82774 11.3767 7.60662 12.181C11.5537 16.9401 16.8504 22.768 23.0888 27.2504C18.7062 29.7914 12.4836 29.9798 6.257 27.2504C4.73944 26.619 3.30917 25.8028 2 24.8209C4.81703 28.9559 8.83711 32.1663 13.539 34.0355C19.5694 36.4535 25.5607 36.2113 29.9196 33.8549Z" fill="#25265E" fill-opacity="0.67"></path>
    ...
    <div class="notification " id="notification" style="display:none;">
      <div class="check-icon-wrapper">
        <img src="./insert_files/check.svg" alt="check">
      </div>
          ...
          <div class="logo-wrapper">
            <h1 class="logo-title-wrapper">
              <a href="https://www.programiz.com/" target="_blank" class="logo-link">
                <img id="logo" src="./insert_files/logo-inverted.svg">
      ...
      <div class="mobile-top-bar clearfix">
        <div class="pills-wrapper">
          <div class="pills clearfix">
            <button class="pill active compiler-pill" id="executed-file-name-mobile" title="DoublyLinkedList.java">DoublyLinkedList.java</button>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="other-options-wrapper">
          ...
          <div class="mobile-top-bar-run-button run"><img src="./insert_files/play.svg" alt="run-icon"></div>
        </div>
      </div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M29.9196 33.8549C32.0265 33.0205 36.1973 31.7405 38.4533 35.8806C38.9712 36.8532 40.1207 31.7059 35.9618 26.8506L35.8873 26.7661C35.9081 26.6956 35.9286 26.6286 35.9487 26.5631C35.9889 26.4317 36.0272 26.3061 36.0638 26.1702C38.159 18.6894 33.1565 9.75527 24.7445 5C28.3777 9.66308 30.0412 15.2949 28.5857 20.25C28.4536 20.7083 28.2951 21.1588 28.1109 21.5995C27.9383 21.4841 27.7225 21.361 27.4439 21.2149C21.1601 17.3644 15.3113 12.871 9.99608 7.81009C13.1936 12.2165 16.7354 16.3731 20.5896 20.2423C17.8902 18.7855 10.3022 13.638 5.53115 9.5593C6.1325 10.4985 6.82774 11.3767 7.60662 12.181C11.5537 16.9401 16.8504 22.768 23.0888 27.2504C18.7062 29.7914 12.4836 29.9798 6.257 27.2504C4.73944 26.619 3.30917 25.8028 2 24.8209C4.81703 28.9559 8.83711 32.1663 13.539 34.0355C19.5694 36.4535 25.5607 36.2113 29.9196 33.8549Z" fill="#25265E" fill-opacity="0.67"></path>
      ...
      <div class="editor-wrapper">
        <div class="editor-desktop-top-bar">
          <div class="file-name" id="executed-file-name" title="DoublyLinkedList.java">DoublyLinkedList.java</div>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div id="editor" class=" ace_editor ace-twilight ace_dark ace_focus" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 451px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" aria-label="Cursor at row 182" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 450px; left: 69px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 57px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -3553px; left: 0px; width: 57px;"><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3542px;">162<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3564px;">163<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3586px;">164<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3608px;">165<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3630px;">166<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3652px;">167<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3674px;">168<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3696px;">169<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3718px;">170<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3740px;">171<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3762px;">172<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3784px;">173<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3806px;">174<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3828px;">175<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3850px;">176<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3872px;">177<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3894px;">178<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3916px;">179<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3938px;">180<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3960px;">181<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-active-line ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 3982px;">182<span tabindex="0" style="display: none; height: 22px;" class="ace_fold-widget ace_start ace_open" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div></div></div><div class="ace_scroller " style="line-height: 22px; left: 57px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -11px; left: 0px; width: 582px; height: 495px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 644px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_selection ace_br1 ace_start" style="height: 22px; right: 4px; top: 0px; left: 4px;"></div><div class="ace_selection ace_br12" style="height: 22px; width: 8px; top: 440px; left: 4px;"></div><div class="ace_selection" style="height: 418px; right: 4px; top: 22px; left: 4px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 8px; top: 440px; left: 4px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: -3542px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 3542px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">pos</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">sc</span>.<span class="ace_entity ace_name ace_function">nextInt</span>();</div></div><div class="ace_line_group" style="height: 22px; top: 3564px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">obj</span>.<span class="ace_entity ace_name ace_function">delete</span>(<span class="ace_identifier">pos</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 3586px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">break</span>;</div></div><div class="ace_line_group" style="height: 22px; top: 3608px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 3630px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">case</span> <span class="ace_constant ace_numeric">5</span><span class="ace_keyword ace_operator">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 3652px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_identifier">obj</span>.<span class="ace_entity ace_name ace_function">display</span>();</div></div><div class="ace_line_group" style="height: 22px; top: 3674px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">break</span>;</div></div><div class="ace_line_group" style="height: 22px; top: 3696px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 3718px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">case</span> <span class="ace_constant ace_numeric">6</span><span class="ace_keyword ace_operator">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 3740px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">println</span>(<span class="ace_string">"Exiting..."</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 3762px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">break</span>;</div></div><div class="ace_line_group" style="height: 22px; top: 3784px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 3806px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">default</span><span class="ace_keyword ace_operator">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 3828px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_entity ace_name ace_function">println</span>(<span class="ace_string">"Invalid Choice"</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 3850px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    }</div></div><div class="ace_line_group" style="height: 22px; top: 3872px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 3894px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    } <span class="ace_keyword">while</span> (<span class="ace_identifier">choice</span> <span class="ace_keyword ace_operator">!=</span> <span class="ace_constant ace_numeric">6</span>);</div></div><div class="ace_line_group" style="height: 22px; top: 3916px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 3938px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">sc</span>.<span class="ace_entity ace_name ace_function">close</span>();</div></div><div class="ace_line_group" style="height: 22px; top: 3960px;"><div class="ace_line" style="height: 22px;">    }</div></div><div class="ace_line_group" style="height: 22px; top: 3982px;"><div class="ace_line" style="height: 22px;">}</div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_animate-blinking"><div class="ace_cursor" style="display: block; top: 440px; left: 12px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; height: 451px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 4004px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 57px; right: 15px; width: 582px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 582px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; font-language-override: inherit; overflow: visible;"></div></div><div class="ace_tooltip" role="tooltip" style="display: none; pointer-events: auto;"></div></div>
      </div>
      ...
      <div class="terminal-wrapper">
        ...
        <div id="terminal" class=" ace_editor ace-twilight ace_dark" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 451px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" aria-label="Cursor at row 121" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 0px; left: 0px;"></textarea><div class="ace_gutter" aria-hidden="true" style="display: none; left: 0px; width: 57px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -2013px; left: 0px; width: 57px;"><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2002px;">92<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2024px;">93<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2046px;">94<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2068px;">95<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2090px;">96<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2112px;">97<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2134px;">98<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2156px;">99<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2178px;">100<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2200px;">101<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2222px;">102<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2244px;">103<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2266px;">104<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2288px;">105<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2310px;">106<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2332px;">107<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2354px;">108<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2376px;">109<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2398px;">110<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2420px;">111<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2442px;">112<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2464px;">113<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2486px;">114<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div></div></div><div class="ace_scroller " style="line-height: 22px; left: 0px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -16px; left: 0px; width: 639px; height: 495px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 644px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: -1848px; left: 0px;"><div class="ace_line_group" style="height: 22px; top: 1848px;"><div class="ace_line" style="height: 22px;">25 &lt;-&gt; 23 &lt;-&gt; 423 &lt;-&gt; 40 &lt;-&gt; 11 &lt;-&gt; NULL</div></div><div class="ace_line_group" style="height: 22px; top: 1870px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 1892px;"><div class="ace_line" style="height: 22px;">1.Insert at Beginning</div></div><div class="ace_line_group" style="height: 22px; top: 1914px;"><div class="ace_line" style="height: 22px;">2.Insert at Middle</div></div><div class="ace_line_group" style="height: 22px; top: 1936px;"><div class="ace_line" style="height: 22px;">3.Insert at End</div></div><div class="ace_line_group" style="height: 22px; top: 1958px;"><div class="ace_line" style="height: 22px;">4.Delete</div></div><div class="ace_line_group" style="height: 22px; top: 1980px;"><div class="ace_line" style="height: 22px;">5.Display</div></div><div class="ace_line_group" style="height: 22px; top: 2002px;"><div class="ace_line" style="height: 22px;">6.Exit</div></div><div class="ace_line_group" style="height: 22px; top: 2024px;"><div class="ace_line" style="height: 22px;">Enter Choice: 4</div></div><div class="ace_line_group" style="height: 22px; top: 2046px;"><div class="ace_line" style="height: 22px;">Enter position to delete: 3</div></div><div class="ace_line_group" style="height: 22px; top: 2068px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 2090px;"><div class="ace_line" style="height: 22px;">1.Insert at Beginning</div></div><div class="ace_line_group" style="height: 22px; top: 2112px;"><div class="ace_line" style="height: 22px;">2.Insert at Middle</div></div><div class="ace_line_group" style="height: 22px; top: 2134px;"><div class="ace_line" style="height: 22px;">3.Insert at End</div></div><div class="ace_line_group" style="height: 22px; top: 2156px;"><div class="ace_line" style="height: 22px;">4.Delete</div></div><div class="ace_line_group" style="height: 22px; top: 2178px;"><div class="ace_line" style="height: 22px;">5.Display</div></div><div class="ace_line_group" style="height: 22px; top: 2200px;"><div class="ace_line" style="height: 22px;">6.Exit</div></div><div class="ace_line_group" style="height: 22px; top: 2222px;"><div class="ace_line" style="height: 22px;">Enter Choice: </div></div><div class="ace_line_group" style="height: 22px; top: 2244px;"><div class="ace_line" style="height: 22px;">5</div></div><div class="ace_line_group" style="height: 22px; top: 2266px;"><div class="ace_line" style="height: 22px;">25 &lt;-&gt; 23 &lt;-&gt; 40 &lt;-&gt; 11 &lt;-&gt; NULL</div></div><div class="ace_line_group" style="height: 22px; top: 2288px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 2310px;"><div class="ace_line" style="height: 22px;">1.Insert at Beginning</div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_slim-cursors ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 792px; left: 252px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; height: 451px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 2662px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 0px; right: 15px; width: 639px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 639px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; font-language-override: inherit; overflow: visible;"></div></div><div class="ace_tooltip" role="tooltip" style="display: none; pointer-events: auto;"></div></div>
      </div>
  ...
  <!-- The use of the cloudflare cdn for all external libraries is intential. We are trying to reduce the number
         of DNS lookups.
    -->
  <script defer="" src="./insert_files/socket.io.min.js.download"></script>
  <script defer="" src="./insert_files/jquery.min.js.download"></script>

  <script defer="" src="./insert_files/ace.js.download"></script>
  <script defer="" src="./insert_files/mousetrap.min.js.download"></script>
  <script defer="" src="./insert_files/final.bb49e05630288743055e.js.download"></script>

  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKXT7MH" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->
<script defer="" src="./insert_files/v67327c56f0bb4ef8b305cae61679db8f1769101564043" integrity="sha512-rdcWY47ByXd76cbCFzznIcEaCN71jqkWBBqlwhF1SY7KubdLKZiEGeP7AyieKZlGP9hbY/MhGrwXzJC/HulNyg==" data-cf-beacon="{&quot;version&quot;:&quot;2024.11.0&quot;,&quot;token&quot;:&quot;0a465ad039704d1f9760ad556f6f3cdd&quot;,&quot;r&quot;:1,&quot;server_timing&quot;:{&quot;name&quot;:{&quot;cfCacheStatus&quot;:true,&quot;cfEdge&quot;:true,&quot;cfExtPri&quot;:true,&quot;cfL4&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfSpeedBrain&quot;:true},&quot;location_startswith&quot;:null}}" crossorigin="anonymous"></script>
